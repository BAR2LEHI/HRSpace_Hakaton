...
# Создаём асинхронный движок на основе
# которого будут создаваться сессии для работы с БД
engine = create_async_engine(SQLALCHEMY_DATABASE_URL)

# Класс sessionmaker'а, который будет отдавать нам
# асинхронную сессию для подключения к БД
